    ...
    <div class="grid grid-cols-7 grid-rows-1 h-full w-full content px-3">
      ...
      <div class="col-start-3 col-end-6 grid grid-rows-5 grid-cols-1 h-full">
        ...
        <div class="row-start-2 row-end-4 pb-3 px-3 flex">
          <div class="flex-1">
            <box-wrapper title="部门占比" :hideBg="true">
              <DepartRadar
                :onResize="windowSize"
                :dateInfo="dateInfo"
              ></DepartRadar>
          ...
          <div class="flex-1">
            <box-wrapper title="工单来源渠道分析" :hideBg="true">
              <OrderSource
                :onResize="windowSize"
                :dateInfo="dateInfo"
              ></OrderSource>
...
const OrderClassification = defineAsyncComponent(() =>
  import(
    '@/pages/DashBoard/FosunPharmaceutical/components/OrderClassification.vue'
  ),
);
const OrderStatus = defineAsyncComponent(() =>
  import('@/pages/DashBoard/FosunPharmaceutical/components/OrderStatus.vue'),
);
const OrderSolutionInfo = defineAsyncComponent(() =>
  import(
    '@/pages/DashBoard/FosunPharmaceutical/components/OrderSolutionInfo.vue'
  ),
);
...
const HotStop = defineAsyncComponent(() =>
  import('@/pages/DashBoard/FosunPharmaceutical/components/HotStop.vue'),
);
const DepartRadar = defineAsyncComponent(() =>
  import('@/pages/DashBoard/FosunPharmaceutical/components/DepartRadar.vue'),
);
const OrderSource = defineAsyncComponent(() =>
  import('@/pages/DashBoard/FosunPharmaceutical/components/OrderSource.vue'),
);
