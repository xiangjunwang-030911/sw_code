<template>
  ...
  import { getNameCountGroupByCustomerField as get2NameCountGroupByCustomerFieldApi } from '@/api/dashboard/haojing';
  ...
  const get2IdNameCountGroupBy2Field = async (dtFrom: string, dtTo: string) => {
    await get2NameCountGroupByCustomerFieldApi({
      projectId: 106,
      fieldId: 22,      
      dtFrom,
      dtTo,
