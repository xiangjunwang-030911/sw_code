  ...
  <div class="wscn-http404-container">
    <div class="wscn-http404">
      ...
      <div class="bullshit">
        ...
        <div class="bullshit__info">{{ $t('errorPage.error_message_info') }}</div>
        <a href="javascript:;" class="bullshit__return-home" @click="$router.back()">{{ $t('errorPage.back') }}</a>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    message() {
      return this.$t('errorPage.error_message_tips')
    }
  }
}
</script>
