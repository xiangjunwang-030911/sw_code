  ...
  <div class="bg-default h-full w-full pl-10 pr-10">
    ...
    >
      ...
      >
        ...
        <template #dropdown>
          <el-dropdown-menu>
            <el-dropdown-item command="a">1.新建桌面事件</el-dropdown-item>
            <el-dropdown-item command="b">2.新建应用事件</el-dropdown-item>
            <el-dropdown-item command="c">3.新建SAP事件</el-dropdown-item>
            <el-dropdown-item command="d">4.VPN权限申请</el-dropdown-item>
            <el-dropdown-item command="e">5.1DMS内部账号创建(公司体系内)</el-dropdown-item>
            <el-dropdown-item command="f">5.2DMS外部账号创建(公司体系外)</el-dropdown-item>
            <el-dropdown-item command="g">5.3DMS账号提前停用(仅外部账号)</el-dropdown-item>
            <el-dropdown-item command="h">5.4DMS账号延长期限(仅外部账号)</el-dropdown-item>
            <el-dropdown-item command="k">5.5DMS一级文件夹管理员权限申请</el-dropdown-item>
            <el-dropdown-item command="l">6.基础架构问题</el-dropdown-item>
          </el-dropdown-menu>
        </template>
      </el-dropdown>
    </div>
...
const handleNew = (command:string|number|object) => {
  // ElMessage(`click on item ${command}`)
  if(command=="a") router.push({ name: 'SP-Event-Add' });
};
